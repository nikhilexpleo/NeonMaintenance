...
public class pettyCashIssuedRepaid_Transcation_PF {
	...
	public pettyCashIssuedRepaid_Transcation_PF(Pojo pojo){
	...
	private By pettyCashIssuedTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Petty Cash Issued')]");
	
	private By pettyCashRepaidTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Petty Cash Repaid')]");
	...
	public void navigateToPettyCashRepaidTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(pettyCashRepaidTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
	//	objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByRandomIndex(subAccountDropDown, 11, 1), false);
		objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByIndex(subAccountDropDown,1), false);

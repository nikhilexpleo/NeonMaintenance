...
public class sundryIncomeExpenses_Transcation_PF {
	...
	public sundryIncomeExpenses_Transcation_PF(Pojo pojo){
	...
	private By sundryIncomeReversalTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Sundry Income Reversal')]");	
	private By sundryIncomeTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Sundry Income')]");
	private By sundryCostsReversalTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Sundry Costs Reversal')]");	
	private By sundryCostsTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Sundry Costs')]");
	...
	public void navigateToSundryCostsReversalTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(sundryCostsReversalTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
	//	objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByRandomIndex(subAccountDropDown, 11, 1), false);
		objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByIndex(subAccountDropDown,1), false);
	...
	public void navigateTosundryIncomeTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(sundryIncomeTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
	//	objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByRandomIndex(subAccountDropDown, 11, 1), false);
		objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByIndex(subAccountDropDown,1), false);
	...
	public void navigateToSundryIncomeReversalTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(sundryIncomeReversalTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
	//	objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByRandomIndex(subAccountDropDown, 11, 1), false);
		objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByIndex(subAccountDropDown,1), false);

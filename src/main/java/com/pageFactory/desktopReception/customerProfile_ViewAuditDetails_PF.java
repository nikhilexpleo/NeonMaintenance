...
public class customerProfile_ViewAuditDetails_PF {
	...
	public customerProfile_ViewAuditDetails_PF(Pojo pojo)
	{
	...
	private By customerProfile_AuditTab=By.xpath("//section[@class='sidebar']//li[@id='tabAudit']//a[contains(.,'Audit')]");
	...
	private By tableFooter=By.xpath("//table[@class='grid datagrid']//tfoot//tr//td");
	...
	{
		objWrapperFunctions.scrollTab(customerProfile_AuditTab);	
	}
	...
	{
		System.out.println("************Customer Audit Records **************");
	...
	//	System.out.println(t);
		for(int i=1;i<=tablesize;i++)
		{
			for(int j=1;j<=columnSize;j++)
			{
				...
				tableFooter=By.xpath("//table[@class='grid datagrid']//tfoot//tr[1]//td[1]");

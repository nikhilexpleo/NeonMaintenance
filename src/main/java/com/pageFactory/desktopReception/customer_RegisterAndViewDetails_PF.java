...
//				objUtilities.logReporter("Click on Save btn", objWrapperFunctions.click(saveBtn), false);	
//			}
			if(objWrapperFunctions.checkElementDisplyed(LogVisit))
			{
				try{
			
				objWrapperFunctions.waitForElementPresence(noBtn);
				objWrapperFunctions.waitForElementToBeClickable(noBtn);
				objUtilities.logReporter(" click on LogVisit No Btn", objWrapperFunctions.click(noBtn), false);
				//objUtilities.logReporter(" click on ok Btn", objWrapperFunctions.click(okBtn), false);
				}
				catch (Exception a) {}
			}
				...
				if (objWrapperFunctions.checkElementDisplyed(noMatchBtn)) {
					try {
						objUtilities.logReporter(" click on No Match Btn", objWrapperFunctions.click(noMatchBtn),
								false);
						Thread.sleep(10000);
						if (objWrapperFunctions.checkElementDisplyed(LogVisit)) {
							objUtilities.logReporter(" click LogVisit No Btn",
									objWrapperFunctions.click(noBtn), false);
...
//						// objUtilities.logReporter(" click on ok Btn",

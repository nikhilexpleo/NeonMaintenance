...
public class CustomerProfile_TestCases extends BaseTest
{
	...
	@Test(priority = 0)
	public void checkCustomerProfileViewRemoveAddAddress()
	{
		//create New Credit Account
		objTopNavCustomer = new TopNavigation_Customers(this);
		objlogin_PF = new login_PF(this);
		objlogin_PF.login();
		objTopNavCustomer.viewRemoveAddAddress(); // This covers View customer details.
		objlogin_PF.logout();
		tearDown();

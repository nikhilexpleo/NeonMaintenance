...
public class PlayerTracking_ViewHospitalityTransaction extends BaseTest
{
	...
	@Test(priority = 0)
	public void checkPlayerTrackingViewHospitalityTransaction()
	{
		//create New Credit Account
		objTopNavCustomer = new TopNavigation_PlayerTracking(this);
		objlogin_PF = new login_PF(this);
		objlogin_PF.login();
	//	objTopNavCustomer.hospitalityTransaction(); // This covers View customer details.

...
public class TC14232_UsersShouldbeAbleTofilterEDDsonOpen extends BaseTest{
	...
	@Title("Test 14232")
	@Description("Users should be able to filter EDD's on Open ")
	@Test
	public void tc14231_SetActualLossValueCanbeEnteredWhenCreatingManualEDDRecord()
	{
		this.setEnviorment();
		objlogin_PF.login();
		...
		objCustomerDueDiligenceFilter_PF.verifySearchResultDisplayAsPerSearchCirteria("Due Diligence State","Open");

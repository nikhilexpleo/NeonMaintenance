...
public class TC14240_incidentCreatedAsSelfExclusion extends BaseTest{
	...
	@Title("Test 14240")
	@Description(" Ensure an Incident can be created as a self Exclusion ")
	@Test(dataProvider = "TestDataProvider")
	public void tc14252_createIncidentAsSelfExclusion(String strRun, Hashtable<String, String> dataSetValue)
	{
		...
		objCustomerProfile_Incidents.selectIncidentTypeFromDropdown("Self Exclusion");
		objcustomerProfile_AddViewDueDiligence_PF.clickOnOk();
		objCustomerProfile_Incidents.verifyIncidentTitle("Self Exclusion");

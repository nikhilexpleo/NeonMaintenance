...
public class Test6427_CustProfileUnableLiftGlobalSuspension extends BaseTest {
	...
	@Test
	public void verifyTest6427_CustProfileUnableLiftGlobalSuspension()
	{
		...
		objCustProfile_EditSuspensionAnotherCasino_PF.verifyLiftGlobalSuspensionMessage();

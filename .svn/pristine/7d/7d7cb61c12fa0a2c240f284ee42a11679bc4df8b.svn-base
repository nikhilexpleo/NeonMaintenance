...
public class TC14262_VerifyCustomerSuspensionCanbeLifted_to_GroupwideBarredBehaviour extends BaseTest{
	...
	public void tc14252_LiftSuepensionGroupwideBarredBehaviour(String strRun, Hashtable<String, String> dataSetValue)
	{
	...
	//	objCommonView.verifySuspensionStatusDoesNotDisplayOnCustomerDetailsPage(getObjUtilities().dpString("Suspension Type"));
	}

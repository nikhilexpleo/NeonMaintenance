...
public class Test6388_CustRegistration_SuspendedCust extends BaseTest{
	...
	public void tc6388_NormalRegistration(String strRun, Hashtable<String, String> dataSetValue)
	{
		...
		objCustomerRegistration.selectMatchProfileFromList();

...
public class setupCreditDebit_Transcation_PF {
	...
	public setupCreditDebit_Transcation_PF(Pojo pojo){
	...
	private By setupCreditTab=By.xpath("//li//a[contains(.,'Setup Credit')]");	
	private By setupDebitTab=By.xpath("//li//a[contains(.,'Setup Debit')]");	
	...
	public void navigateToSetupCreditTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(setupCreditTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);	
	}
	
	public void navigateTosetupDebitTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(setupDebitTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);	
	}

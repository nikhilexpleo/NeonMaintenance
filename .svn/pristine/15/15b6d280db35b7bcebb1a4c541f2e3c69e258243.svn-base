...
public class bank_PF 
{
	...
	private By bankingTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Banking')]");
	
	private By cashFloatIssuedTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Cash Float Issued')]");
	
	private By cashFloatReturnedTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Cash Float Returned')]");
	
	private By CashFromBankTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Cash From Bank')]");
	private By centralCharityDonationsTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Central Charity Donations')]");
	
	private By centralCharityDonationsReversalTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Central Charity Donations Reversal')]");
	...
	public void navigateToBankingTab()
	{
		...
		objWrapperFunctions.scrollTab(bankingTab);;
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);	
	}
	
	public void navigateToCashFromBankTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(CashFromBankTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
	}
	
	public void navigateTocashFloatIssuedTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(cashFloatIssuedTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
	...
	public void navigateTocashFloatReturnedTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(cashFloatReturnedTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
	//	objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByRandomIndex(subAccountDropDown, 11, 1), false);
		objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByIndex(subAccountDropDown,1), false);
	...
	public void navigateToCentralCharityDonationsTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(centralCharityDonationsTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
		//objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByRandomIndex(subAccountDropDown, 2, 1), false);
		objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByIndex(subAccountDropDown,1), false);
		String subAccount=objWrapperFunctions.getSelectedValueFromDropDown(subAccountDropDown);
		System.out.println("Sub Account : "+subAccount);
	}
	...
	public void navigateToCentralCharityDonationsReversalTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(centralCharityDonationsReversalTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);
		//objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByRandomIndex(subAccountDropDown, 2, 1), false);		
		objUtilities.logReporter("select sub account", objWrapperFunctions.selectDropDownByIndex(subAccountDropDown,1), false);

...
public class TC14252_VerifyCustomerCanBeSetToGroupwideBarred_Behaviour extends BaseTest{
	...
	public void tc14252_SetGroupwideBarredBehaviourToCustomerProfile(String strRun, Hashtable<String, String> dataSetValue)
	{

...
public class Pojo 
{
	...
	private CustomReporterNew objReporter;
	...
	private String user,Machine,PMAPassword,user1Value,user2Value,pass,testName,NeonUser,NeonPassword,userDOB,debNum; 
	...
	public void setCustomeReporter(CustomReporterNew reporter)
	{
		this.objReporter = reporter;
	}

	public CustomReporterNew getCustomeReporter()
	{
		return objReporter;
	}
	...
	public void setDebitCardNum(String debtNum)
	{
		this.debNum = debtNum;
	}

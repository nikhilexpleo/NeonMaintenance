...
public class Test6423_CustProfile_EditSuspensionAnotherCasino extends BaseTest {
	...
	@Test
	public void verifyTest6423CustProfile_EditSuspensionAnotherCasino()
	{
		...
		objCustProfile_EditSuspensionAnotherCasino_PF.verifyMessage();

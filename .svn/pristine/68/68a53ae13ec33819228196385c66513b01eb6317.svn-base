...
public class incentivesRedeemedAndIssued_PF {
	...
	public incentivesRedeemedAndIssued_PF(Pojo pojo){
	...
	private By majorPlayerIncentivesIssuedTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Major Player Incentives Issued')]");
	...
	public void navigateToMajorPlayerIncentivesIssuedTab()
	{
		try
		{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(majorPlayerIncentivesIssuedTab);

...
public class staffSocialFundOnOff_Transcation_PF {
	...
	public staffSocialFundOnOff_Transcation_PF(Pojo pojo){
	...
	private By staffSocialFundOffTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Staff Social Fund Off')]");	
	private By staffSocialFundOnTab=By.xpath("//div[@id='Sidebar_PassTransactions_Sidebar']//li//a[contains(.,'Staff Social Fund On')]");	
	...
	public void navigateTostaffSocialFundOffTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(staffSocialFundOffTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);	
	}
	
	public void navigateTostaffSocialFundOnTab()
	{
		objUtilities.logReporter("Click on transaction Tab", objWrapperFunctions.click(transactionTab), false);
		objWrapperFunctions.scrollTab(staffSocialFundOnTab);
		String text=objWrapperFunctions.getText(headingText);
		System.out.println(text);	
	}

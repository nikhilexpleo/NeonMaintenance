...
public class TC14267_VerifyCustomerSuspensionCanbeLifted_to_RefusedRegistration extends BaseTest{
	...
	@Title("Test 14267")
	@Description("Verify a customer suspension can be lifted when set to Refused Registration ")
	@Test(dataProvider = "TestDataProvider")
	public void tc14257_LiftSuepensionRefusedRegistration(String strRun, Hashtable<String, String> dataSetValue)
	{

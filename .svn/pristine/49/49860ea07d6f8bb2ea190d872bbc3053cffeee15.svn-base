...
public class customerProfile_ViewVisitsDetails_PF {
	...
	public customerProfile_ViewVisitsDetails_PF(Pojo pojo)
	{
	...
	private By customerProfile_VisitsTab=By.xpath("//section[@class='sidebar']//li[@id='tabVisits']//a[contains(.,'Visits')]");	
	private By customerProfile_Visits_CollapsedButton=By.xpath("//button[@class='collapsor active']");
	private By customerProfile_Visits_dateInputBox=By.xpath("//input[@id='StartGamingDate']");	
	...
	{
		objWrapperFunctions.scrollTab(customerProfile_VisitsTab);	
	}
	...
	{
		System.out.println("************Customer Visits Details **************");
	...
	{
		objUtilities.logReporter("Click on Collpased button ", objWrapperFunctions.click(customerProfile_Visits_CollapsedButton), false);
		...
		objUtilities.logReporter("Click on Start date ", objWrapperFunctions.click(customerProfile_Visits_dateInputBox), false);
		objUtilities.logReporter("set start date", objWrapperFunctions.setText(customerProfile_Visits_dateInputBox,convertedDate), false);
		objUtilities.logReporter("Click on find button ", objWrapperFunctions.click(findButton), false);
	}
}
